...
def select_db_isolate(isolatename):
    ...
    for line1 in data1:
        ...
        for line2 in data2:
            ...
            f3.write(str(n[0]))
            f3.write(' ')
            f3.write(str('{:.2f}'.format(float(n[3]))))
            f3.write(' ')
            f3.write(str('{:.0f}'.format(float(listcount[0]))))
            f3.write(' ')
    ...
    sorted_id_all = sorted(range(len(isolateaverage_2_db_cluster_select)), key = lambda x:isolateaverage_2_db_cluster_select[x], reverse=True)    
    ...
    for i in range(match.shape[0]):
        ...
        f3.write("	")
        f3.write(str('{:.2f}'.format(float(isolateidentity_db_cluster_final[i]))))
        f3.write("	")
        f3.write(str('{:.0f}'.format(float(isolatecount_db_cluster_final[i]))))
        f3.write("	")
        f3.write(str('{:.2f}'.format(float(isolateaverage_db_cluster_final[i]))))
        f3.write("	")
        f3.write(str('{:.2f}'.format(float(isolateaverage_2_db_cluster_final[i]))))
        f3.write("	")
        f3.write(str('{:.0f}'.format(float(listcount_db_cluster_final[i]))))
        f3.write("	")
